...
//		public Rigidbody rb;
	...
	//	}
		//I still find the [] brackets to be quite strange...
		...
		public float capsuleHeightStanding = 9.84f;
		[Tooltip("Height of character when crouching")]
		public float capsuleHeightCrouching = 8f;
...
//	if(Input.GetKey(left))
	...
	//	rb.AddForce(transform.back * -1);
	//}

//	if(Input.GetKey(back))
	//{
//rb.AddForce(transform.back * speed);
	//}
