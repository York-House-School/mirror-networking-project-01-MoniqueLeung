...
public class FPSscript2 : NetworkBehaviour
{
  ...
  public bool canMove = true;
    ...
    void momoPlayerMovement()
    {
      if(isLocalPlayer)
      {
        ...
        //curly brace for the if isLocalPlayer statment
      }

    //last curly brace for  the momo method
    }
...
//last curly brace DON'T DELETE IT
}
